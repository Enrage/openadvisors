...
document.addEventListener("DOMContentLoaded", function () {
  function timeNow() {
    ...
    var timeStart = "".concat(day, ".").concat(month, ".").concat(year, " ").concat(hour, ":").concat(minutes, ":").concat(seconds);
    return timeStart;
  }

  var topMenuBtn = document.querySelector('.top_menu_btn');
  var topMenu = document.querySelector('.top_menu_list');

  if (topMenuBtn) {
    topMenuBtn.onclick = function (e) {
      e.preventDefault();
      console.log(e); // console.log(topMenu.style);

      if (topMenu.style.display != 'flex') {
        topMenu.style.display = 'flex'; // topMenu.classList.add('b-show');
        // topMenu.classList.remove('b-hidden');
      } else {
        topMenu.style.display = 'none'; // topMenu.classList.add('b-hidden');
  ...
  var start = document.querySelector('.frv_start');
  var comments = []; // Frv first form error

  var error = document.querySelector('.error'); // Frv second form error

  var error2 = document.querySelector('.error_2'); // Кого нормируем

  var regulate = document.querySelector('#frv_name'); // First form

  var startForm = document.querySelector('#first_frv_form'); // Second form

  var secondForm = document.querySelector('#second_frv_form'); // Result block

  var resultBlock = document.querySelector('#frv_result_block');
  ...
  var comment = document.querySelector('#frv_comment'); // Input code data

  var code = document.querySelector('#frv_code');
  ...
  var done = document.querySelector('.frv_done');
  ...
  var finish = document.querySelector('.frv_finish');
  ...
  if (finish) {
    finish.onclick = function (e) {
      ...
      if (checkComment(comment.value) && checkCode(code.value)) {
        ...
        comment.value = '';
        code.value = '';
        var operations = JSON.stringify(comments);
        var headers = {
          'Content-Type': 'application/json'
        };
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/operation_save', {
          ...
          var frvResult = document.querySelector('.frv_result_text');
          frvResult.innerHTML = "\u0412 \u0442\u0435\u0447\u0435\u043D\u0438\u0435 10 \u043C\u0438\u043D\u0443\u0442 \u043D\u0430 \u0412\u044B\u0448\u0443 \u043F\u043E\u0447\u0442\u0443 <span class=\"bold\">".concat(response.data, "</span> \u0431\u0443\u0434\u0435\u0442 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430 \u0442\u0430\u0431\u043B\u0438\u0446\u0430 \u0441 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u0430\u043C\u0438 \u043D\u043E\u0440\u043C\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F!");
        });
      } else {
        if (!checkComment(comment.value)) {
          comment.classList.add('bd_error');
  ...
  var oneMoreBtn = document.querySelector('.frv_one_more');
  var toAccountBtn = document.querySelector('.frv_to_account');
  ...
  var logout = document.querySelector('.frv_logout_btn');
  ...
  var manual = document.querySelector('.frv_manual_btn');
  ...
  var frv = document.querySelector('.img_frv');
  var about = document.querySelector('.about_frv');
  ...
  var updateProfile = document.querySelector('#save_profile');
...
function () {
  ...
  _createClass(Validator, [{
    ...
    value: function checkPhone(phone) {
      if (phone.length > 0) {
        if (/^(\+)?\d+$/.test(phone)) return true;else return false;
      }
...
module.exports = __webpack_require__(/*! /home/enrage/Projects/openadvisors/openadvisors/resources/js/common.js */"./resources/js/common.js");
